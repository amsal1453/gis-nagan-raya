...
const HeroSection = () => {
    ...
    return (
        <div className="bg-gradient-to-r from-[#08244d] to-[#0A4D8C] h-[calc(100vh-800px)] min-h-[500px] flex items-center overflow-x-hidden">
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
                <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                    ...
                    <div className=" md:mt-0 h-[500px] flex justify-center">
                        <Globe
                            ref={globeRef}
