...
export default function Create({ villages, categories, subdistricts }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        description: "",
        categories: [],
        location: null, // untuk point
        area: null, // untuk polygon
        line: null, // untuk line
    });
    ...
    const handleCreated = (e) => {
        ...
        // Reset semua nilai geometri terlebih dahulu
        setData((prevData) => ({
            ...prevData,
            location: null,
            area: null,
        ...
        // Menentukan tipe geometri dan menyimpan ke state yang sesuai
    ...
    const handleDeleted = (e) => {
        // Reset semua geometri yang dihapus
        setData((data) => ({
            ...data,
            location: null,
            area: null,
        ...
        <MainLayout>
            ...
            <div className="p-4 mb-6 bg-primary rounded-lg shadow">
                ...
                <p className="mt-2 text-sm text-gray-100">
                    * Gunakan tools di sebelah kanan peta untuk menambah titik,
                    garis, atau area
                </p>
            </div>
